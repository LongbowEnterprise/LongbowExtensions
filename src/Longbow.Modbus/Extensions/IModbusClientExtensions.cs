...
public static class IModbusClientExtensions
{
    ...
    public static ValueTask<bool> ConnectAsync(this IModbusClient client, string ipString, int port, CancellationToken token = default)
    {
